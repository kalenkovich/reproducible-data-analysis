...
Отдельный бонус от использования GitHub - в него встроен issue tracker.
Крайне советую им пользоваться.
Ишью (*issue*) может быть задача, которую вам надо сделать, баг, который вам надо исправить, вопрос, который вам надо обсудить.
Крайне удобно для проджект-менеджмента (в случае задач и багов), а также для того, чтобы потом не спрашивать себя "почему мы решили сделать X, а не Y".

Также ишьюс (раздел github, в котором живут все ишью данного репозитория) - то место, куда можно и нужно обращаться, если вы нашли баг в каком-то открытом пакете или у вас возникгли проблемы с его работой.

Этот сайт тоже базируется на репозитории GitHub, поэтому к нему тоже привязаны ишьюс - вот [здесь](https://github.com/kalenkovich/reproducible-data-analysis/issues).

*Задание (по желанию)*

- Сообщите об опечатке на этом сайте, создав ишью.
